...
class ShortestPathBetweenPoints(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        fields = QgsFields()
        fields.append(QgsField('start_id', QMetaType.Type.QString))
        fields.append(QgsField('start_coordinates', QMetaType.Type.QString))
        fields.append(QgsField('start_entry_cost', QMetaType.Type.Double))
        fields.append(QgsField('end_id', QMetaType.Type.QString))
        fields.append(QgsField('end_coordinates', QMetaType.Type.QString))
        fields.append(QgsField('end_exit_cost', QMetaType.Type.Double))
        fields.append(QgsField('cost_on_graph', QMetaType.Type.Double))
        fields.append(QgsField('total_cost', QMetaType.Type.Double))
