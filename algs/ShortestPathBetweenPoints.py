...
class ShortestPathBetweenPoints(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        fields = QgsFields()
        fields.append(QgsField('start_id', QMetaType.QString))
        fields.append(QgsField('start_coordinates', QMetaType.QString))
        fields.append(QgsField('start_entry_cost', QMetaType.Double))
        fields.append(QgsField('end_id', QMetaType.QString))
        fields.append(QgsField('end_coordinates', QMetaType.QString))
