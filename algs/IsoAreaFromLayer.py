...
class IsoAreaFromLayer(QgsProcessingAlgorithm):
    ...
    def icon(self):
        return QIcon(os.path.join(pluginPath, 'icons', 'icon_servicearea_polygon_multiple.svg'))
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        max_off_graph_travel_cost: float = self.parameterAsDouble(parameters, self.MAX_OFF_GRAPH_TRAVEL_COST, context) #0.0 if not se
