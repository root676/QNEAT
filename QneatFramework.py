...
class QneatCore():
    ...
    def queryOdPair(self, tree: list[int], cost: list[float], origin_point: QneatAnalysisPoint, origin_point_id_field: str, destination_point: QneatAnalysisPoint, destination_point_id_field: str, matrix_type: MatrixType) -> QgsFeature:
        ...
        fields.append(QgsField('entry_cost', QMetaType.Type.Double, '', 20,7))
        fields.append(QgsField('network_cost', QMetaType.Type.Double, '', 20, 7))
        fields.append(QgsField('exit_cost', QMetaType.Type.Double, '', 20,7))
        fields.append(QgsField('total_cost', QMetaType.Type.Double, '', 20,7))
    ...
    def calcIsoPoints(self, max_cost: float, progress_range: ProgressRange, densify_distance: float | None = None, id_field_datatype: QMetaType.Type = QMetaType.Type.LongLong) -> list[QgsFeature]:
        iso_points = dict()

        output_fields = QgsFields()
        output_fields.append(QgsField('vertex_id', QMetaType.Type.LongLong))
