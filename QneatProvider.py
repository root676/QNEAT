...
class QneatProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        self.addAlgorithm(IsoAreaAsCostSurfaceFromPoint.IsoAreaAsCostSurfaceFromPoint())
        self.addAlgorithm(IsoAreaAsCostSurfaceFromLayer.IsoAreaAsCostSurfaceFromLayer())
